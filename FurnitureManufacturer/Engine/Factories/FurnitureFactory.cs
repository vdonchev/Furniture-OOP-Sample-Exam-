namespace FurnitureManufacturer.Engine.Factories
{
    ...
    public class FurnitureFactory : IFurnitureFactory
    {
        ...
        public ITable CreateTable(string model, string materialType, decimal price, decimal height, decimal length, decimal width) =>
            new Table(model, this.GetMaterialType(materialType).ToString(), price, height, length, width);

        public IChair CreateChair(string model, string materialType, decimal price, decimal height, int numberOfLegs) =>
            new Chair(model, this.GetMaterialType(materialType).ToString(), price, height, numberOfLegs);
        ...
        public IAdjustableChair CreateAdjustableChair(string model, string materialType, decimal price, decimal height, int numberOfLegs) =>
            new AdjustableChair(model, this.GetMaterialType(materialType).ToString(), price, height, numberOfLegs);

        public IConvertibleChair CreateConvertibleChair(string model, string materialType, decimal price, decimal height, int numberOfLegs) => new ConvertibleChair(model, this.GetMaterialType(materialType).ToString(), price, height, numberOfLegs);
